...
function _renderWorkout(workout) {
  ...
  <div class="workout__details">
    ...
    <span class="workout__icon">${workout.type === 'running' ? '🏃‍♂️' : 'CYC'
    } </span>
    <span class="workout__value" data-unit="distance" contenteditable="true">${workout.distance}</span>
    <span class="workout__unit">km</span>
  </div>
  <div class="workout__details" >
    <span class="workout__icon">⏱</span>
    <span class="workout__value" data-unit="duration" contenteditable="true">${workout.duration}</span>
  ...
  if (workout.type === 'running')
    ...
    <div class="workout__details">
      ...
      <span class="workout__value" data-unit="pace" contenteditable="true">${workout.pace.toFixed(1)}</span>
      <span class="workout__unit">min/km</span>
    </div>
    <div class="workout__details">
      <span class="workout__icon">🦶🏼</span>
      <span class="workout__value" data-unit="cadence" contenteditable="true">${workout.cadence}</span>
  ...
  <div class="workout__details">
    <span class="workout__icon">⚡️</span>
    <span class="workout__value" data-unit="speed" contenteditable="true">${workout.speed.toFixed(1)}</span>
    <span class="workout__unit">km/h</span>
  </div>
  <div class="workout__details">
    <span class="workout__icon">⛰</span>
    <span class="workout__value" data-unit="elevationGain" contenteditable="true">${workout.elevationGain}</span>
...
function saveToStorage(e) {
  e.preventDefault()
  const id = currEditElement.parentElement.parentElement.getAttribute('data-id')
